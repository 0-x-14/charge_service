 ...
 * Use the [HomeUsingFragment.newInstance] factory method to
...
class HomeUsingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding = HomeUsingBinding.inflate(layoutInflater)
    ...
    companion object {
         ...
         * @return A new instance of fragment HomeUsingFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            HomeUsingFragment().apply {
